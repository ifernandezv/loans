$(document).ready(function () {
    ...
    $('#customer_form').validate({
        ...
        messages:
                {
                    first_name: $("#hidden-error-first-name").val(),
                    last_name: $("#hidden-error-last-name").val(),
                    email: $("#hidden-error-email").val()
                }
    });
});
...
function init_profile_uploader()
{
    ...
    var uploader = new plupload.Uploader({
        ...
        url: $("#site_url").val() + 'customers/upload',
        unique_names: true,
        ...
        init: {
            ...
            UploadComplete: function (up, files) {
                plupload.each(files, function (file) {
                    var src = $("#site_url").val() + "uploads/profile-" + $("#pickfiles").data("person-id") + "/" + file.target_name;
