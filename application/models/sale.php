...
//  ACA ESTA EL PROBLEMA !!!!
  ...
  {    
    $location_id = $this->Employee->get_logged_in_employee_current_location_id();    
    $this->db->from('sales');
    $this->db->join('pdv.customers as customers', 'sales.customer_id = customers.person_id', 'left');
    $this->db->join('pdv.people as people', 'customers.person_id = people.person_id', 'left');
