  ...
  function imprimir_reporte() {
    ...
    foreach ($payments->result() as $payment) {
      ...
      $format_result[] = array(
        ...
        $payment->loan_id,
        to_currency($payment->loan_balance),
    ...
    ini_set('memory_limit', '256M'); // boost the memory limit if it's low <img src="https://davidsimpson.me/wp-includes/images/smilies/icon_wink.gif" alt=";)" class="wp-smiley">
