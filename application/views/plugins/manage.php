...
<div id="title_bar">
    <div id="title" class="float_left"><i class="fa fa-gavel" style="font-size: 40px; color:#1b926c"></i> <?php echo $this->lang->line('common_list_of') . ' ' . $this->lang->line('module_' . $controller_name); ?></div>
    ...
    <div id="new_button">
        ...
        <div style="display: inline-block; margin-right: 20px">
            ...
            <div id="container">
                <a id="pickfiles" href="javascript:;" class="btn btn-default" data-person-id=""><?=$this->lang->line("common_browse");?></a> 
            </div>

        </div>

        <?php
        //echo anchor("$controller_name/view/-1", "<div class='btn btn-primary' style='float: left; margin-right:5px;'><span>" . $this->lang->line($controller_name . '_new') . "</span></div>", array('class' => 'thickbox none', 'data-toggle' => 'modal', 'data-target' => '#loan_type_modal', 'title' => $this->lang->line($controller_name . '_new')));
        ?>
    </div>
</div>
...
<div id="table_action_header">
    <div class="row">
        <div class="col-xs-3">
            <?php echo anchor("$controller_name/delete", $this->lang->line($controller_name."_delete"), array('id' => 'delete', 'class' => 'btn btn-danger')); ?>
        </div>
        <div class="col-xs-3">
            &nbsp;
        </div>
