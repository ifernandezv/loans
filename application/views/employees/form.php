...
<div class="modal-body">
  <div style="overflow-y: scroll" id="div-form">
    ...
    <fieldset id="employee_permission_info">
      ...
      <label class="required"><?php echo $this->lang->line("employees_permission_desc"); ?></label>
...
<div class="modal-footer">
    <button type="button" class="btn btn-default" data-dismiss="modal" id="btn-close"><?php echo $this->lang->line("common_close"); ?></button>
    <?php
    echo form_submit(
      array(
        'name' => 'submit',
