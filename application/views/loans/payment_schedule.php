    ...
    <body>
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td><?= $loan_type->term . " " . $this->lang->line('common_'.strtolower($loan_type->term_period_type)); ?></td>
                <td><?= ($loan_type->term_period_type === "year") ? "APR" : "Interés"; ?></td>
                <td><?= $apr ?></td>
            </tr>
            <tr>
                ...
                <td><?= date("d/m/Y", $loan->loan_payment_date); ?></td>
            </tr>
        </table>
            ...
            <table width="100%" class="custom_table">
                <tr>
                   <td align="center"><strong>Cuota</strong></td>
                    ...
                    <td align="center"><strong>Interés</strong></td>
                    <td align="center"><strong>Cuota</strong></td>
                    <td align="center"><strong>Saldo</strong></td>
                    <td align="center"><strong>Saldo Actual</strong></td>
                </tr>
            <?php 
      $i=1;
      
      foreach($breakdown_data as $tmp):?>
                <tr>
                  <td>&nbsp;&nbsp;<?=$i?></td>
                    <td>&nbsp;&nbsp;<?=$tmp["month"];?></td>
                    <td align="right"><?=$tmp["capital"];?>&nbsp;&nbsp;</td>
                    <td align="center"><?=$tmp["interest"];?></td>
                    <td align="right"><?=$tmp["pay"];?>&nbsp;&nbsp;</td>
                    <td align="right"><?=$tmp["balance"];?>&nbsp;&nbsp;</td>
                     <td align="right"><?=$tmp["balance2"];?>&nbsp;&nbsp;</td>
                </tr>
            <?php $i++; endforeach;?>
            </table>
        </div>
